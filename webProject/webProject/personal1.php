...
<body>
    ...
    <div id="topLeft" class="class1">
        ...
        <div id="topright" class="class1">
            ...
            <img src="namelogo.jpg" alt="" width="60px">
    ...
    <div id="midpane">
        <form action="" method="post">
            ...
            <div id="formdiv">
                ...
                <br>
                <img src="rec.png" alt="" width="150px" height="150px" id="im1">
    ...
    $result2=mysqli_query($conn,"select a.customerId,a.customerName,a.email,a.contact,a.detailsId,d.skills,d.experience,d.education  from applicant a,details d where a.detailsId=d.detailsId and d.skills='WEB DEVELOPER'");
    ...
    <div id="container">
        <div class="">
            <img src="candidate.png" alt="" class="imag1">
        </div>
...
if(isset($_POST['submit1'])){
    $result2=mysqli_query($conn,"select a.customerId,a.customerName,a.email,a.contact,a.detailsId,d.skills,d.experience,d.education  from applicant a,details d where a.detailsId=d.detailsId and d.skills='DATABASE MANAGER'");
    while($rows1=mysqli_fetch_assoc($result2))
    {
        $idc=$rows1['customerId'];
    $namec=$rows1['customerName'];
...
if(isset($_POST['submit3'])){
    ...
    $result2=mysqli_query($conn,"select a.customerId,a.customerName,a.email,a.contact,a.detailsId,d.skills,d.experience,d.education  from applicant a,details d where a.detailsId=d.detailsId and d.skills='MACHINE ENGINEER'");
    while($rows1=mysqli_fetch_assoc($result2))
    {
    $idc=$rows1['customerId'];
    $namec=$rows1['customerName'];
