...
<body>
    <form action="#" method="post">
        <div id="leftpane">
            <div id="logo">
                <img src="zariyalogo.jpg" alt="zariya" style="border-radius:50%">
            </div>
...
//   $result=mysqli_query($conn,"select * from applicant;");
        ...
        while($r=mysqli_fetch_assoc($res)){?>
            ...
            <?php
            $det=mysqli_query($conn,"SELECT education,experience,skills from applicant,details where applicant.detailsId=details.detailsId and customerId=$id;")
            ?>
            <tr>
